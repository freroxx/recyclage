export default function Posters() {
  ...
  // FIX: Move the activeSection state logic to properly toggle between sections
    ...
    <div className="relative min-h-screen overflow-auto bg-background">
      ...
      <div className="container mx-auto px-3 sm:px-4 py-8 md:py-12 relative z-10">
        <div className="max-w-7xl mx-auto">
          ...
          {/* FIX: Render content based on activeSection */}
          {activeSection === "gallery" ? (
            <GallerySection 
              ...
              hoveredPoster={hoveredPoster}
            />
          ) : (
            <ShareSection currentLanguage={currentLanguage} copyToClipboard={copyToClipboard} />
          )}
        </div>
      </div>
...
// FIX: Extract Gallery Section into its own component
interface GallerySectionProps {
  ...
  setHoveredPoster: (id: number | null) => void;
  hoveredPoster: number | null;
}
...
// FIX: Extract Share Section into its own component
interface ShareSectionProps {
  currentLanguage: string;
  copyToClipboard: (text: string) => void;
}

const ShareSection: React.FC<ShareSectionProps> = ({ currentLanguage, copyToClipboard }) => {
  return (
