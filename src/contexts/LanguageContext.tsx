...
"project.why.title": "Pourquoi participer ?",
    ...
    "footer.project": "Projet",
     "logoAlt": "Logo École Maria",
    "projectName": "Recyclage Maria",
    "schoolName": "École Maria",
    "tagline": "Initiative de développement durable pour un avenir plus vert",
    "project": "Projet",
    "home": "Accueil",
    ...
    "website": "Site Web",
    "makeDifference": "Faites la différence",
    "makeDifferenceDescription": "Chaque contribution compte. Soutenez notre initiative de recyclage.",
    "supportButton": "Soutenir",
    "allRightsReserved": "Tous droits réservés",
    "location": "Agadir, Maroc",
    "credits": "Crédits",
    "aboutProject": "À propos du projet",
    "developmentDesign": "Développement et conception",
    "organization": "Organisation",
    "launched": "Lancement",
    "launchDate": "Décembre 2024",
    "developmentTeam": "Équipe de développement",
    "webDeveloper": "Développeur Web",
    "developerDescription": "Conception, développement et déploiement du site web",
    "projectVision": "Vision du projet",
    "projectVisionDescription": "Créer une plateforme interactive pour promouvoir le recyclage et sensibiliser à l'importance du développement durable dans les écoles.",
    "close": "Fermer",
    "developedWithPassion": "Développé avec passion",
    "educationalProject": "Projet éducatif pour un avenir durable • École Maria, Agadir • Maroc",
...
"project.why.title": "Why Participate?",
    ...
    "logoAlt": "Maria School Logo",
    "projectName": "Recyclage Maria",
    "schoolName": "Maria School",
    "tagline": "Sustainable development initiative for a greener future",
    "project": "Project",
    "home": "Home",
    ...
    "makeDifferenceDescription": "Every contribution counts. Support our recycling initiative.",
    ...
    "developerDescription": "Design, development and deployment of the website",
    "projectVision": "Project Vision",
    "projectVisionDescription": "Create an interactive platform to promote recycling and raise awareness about the importance of sustainable development in schools.",
    "close": "Close",
    "developedWithPassion": "Developed with passion",
    "educationalProject": "Educational project for a sustainable future • Maria School, Agadir • Morocco",
